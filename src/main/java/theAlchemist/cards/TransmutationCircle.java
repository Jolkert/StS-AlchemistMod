...
import theAlchemist.powers.TransmutationCirclePower;

import static theAlchemist.AlchemistMod.makeCardPath;

public class TransmutationCircle extends CustomCard
{
	public static final String ID = AlchemistMod.makeID(TransmutationCircle.class.getSimpleName());
	public static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
	
	public static final String IMAGE = makeCardPath("TransmutationCircle.png");
	...
	{
		AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(player, player, new TransmutationCirclePower(player, this.upgraded)));
	}
