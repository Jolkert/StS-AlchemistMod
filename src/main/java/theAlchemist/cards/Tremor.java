...
public class Tremor extends AbstractElement
{
	public static final String ID = AlchemistMod.makeID(Tremor.class.getSimpleName());
	public static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
	
	public static final String IMAGE = makeCardPath("Tremor.png");
